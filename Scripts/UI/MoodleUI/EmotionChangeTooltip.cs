...
public class EmotionChangeTooltip : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    [SerializeField]
    private LocalizedString[] tooltip_key;
    [SerializeField]
    ...
    private int moodN;
    public void Render(int mood) //스탯패널에서 호출할 함수
    {
        GetComponent<Image>().sprite = emotionSprite[mood];
        moodN = mood;
    }
    private void UpdateTooltipUI()
    {
        // 툴팁 정보 갱신
        mapTooltip.SetItemInfo(null, tooltip_key[moodN]);
