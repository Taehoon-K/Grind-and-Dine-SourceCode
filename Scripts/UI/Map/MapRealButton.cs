...
public class MapRealButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{

    [SerializeField] private LocalizedString[] buildingName;

    [SerializeField] private MapRealTooltip mapTooltip;   // 아이템 정보를 보여줄 툴팁 UI
    ...
    {
        // 툴팁 정보 갱신
        mapTooltip.SetItemInfo(buildingName);
